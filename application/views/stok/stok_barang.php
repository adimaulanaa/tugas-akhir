<div class="content-wrapper" style="margin-bottom: 20px">
    <div class="container">
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">STOK BARANG PER TANGGAL <?php echo $tgl ?></h4>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        ...
                        <?php foreach ($kategori->result() as $key) : ?>
                            <option <?php if ($kat == $key->kd_kategori) {
                                        echo 'selected';
                                    } ?> value="<?php echo $key->kd_kategori ?>"><?php echo $key->nm_kategori ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="sort_stok" id="sort_stok" class="form-control">
                        <option <?php if ($sort == 'all') {
                                    echo 'selected';
                                } ?> value="all">SEMUA</option>
                        <option <?php if ($sort == 'more') {
                                    echo 'selected';
                                } ?> value="more" >Di atas 0</option>
                        <option <?php if ($sort == 'empty') {
                                    echo 'selected';
                                } ?> value="empty">0</option>
                    </select>
                </div>
                <button type="submit" class="btn btn-default">Filter</button>
                <a href="<?php echo base_url('m_stok/stok/') ?>"><button type="button" class="btn btn-success">Reset</button></a>
            </form>
        </div>
        <div class="row">
            <div class="col-md-12">
