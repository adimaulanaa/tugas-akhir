          ...
          <table id="tbStok" class="table table-bordered table-striped table-responsive">
            <thead>
              <tr>
                ...
                <!-- <th>harga beli sebelum</th> -->
                <!-- <th>harga jual sebelum</th> -->
              </tr>
            </thead>
            <tbody>
              <?php foreach ($masuk->result() as $key) : ?>
                <tr>
                  ...
                  <!-- <td align="center"><?php echo number_format($key->sebelum_beli, 0, '.', ',') ?></td> -->
                  <!-- <td align="center"><?php echo number_format($key->sebelum_jual, 0, '.', ',') ?></td> -->
                </tr>
              <?php endforeach ?>
            </tbody>
          </table>
