  <!-- MENU SECTION END-->
  <div class="formSidebar w3-bar-block" style="right:0;padding:15px;" id="rightMenu">
      <button id="judul" onclick="tutupSideForm()" class="w3-bar-item">&times; Close Sidebar</button>
      <form id="formTambah" action="<?php echo base_url('m_stok/simpan_repacking') ?>" method="post">
...
<hr>
      <div class="w3-container">
          <h3>REPACKING STOK <span></span></h3>
          
      </div>

      <div class="w3-container" style="padding:20px;margin-bottom: 10px">
          <table id="tbBarang1" class="table table-bordered table-striped table-responsive" style="width:100%">
              <thead>
                  <tr>
                      <th>Kode</th>
                      <th>Nama Barang</th>
  ...
  <script>
      ...
      $(document).ready(function() {
          ...
          document.getElementById("bukaSide").style.display = "block";
      ...
      $('#tbBarang').DataTable({
          ...
          "serverSide": true,
          "ajax": {
              "url": '<?php echo base_url(); ?>m_stok/json_edit_stok',
              "type": "POST",
          },
          "columns": [{
                  "data": "kd_barang"
       ...
       $(document).ready(function() {
          ...
          $('#tbBarang1').on('click', '.edit_record', function() {
              var kode = $(this).data('kode');
              var nama = $(this).data('nama');
              var stok = $(this).data('stok');
              var stok_min = $(this).data('stok_min');
