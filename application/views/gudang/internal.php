<div class="content-wrapper" style="margin-bottom: 20px">
  <div class="container">
    <div class="row pad-botm">
      <div class="col-md-12">
        <h4 class="header-line">No. Faktur : <?php echo $faktur->no_faktur_internal ?></h4>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <table cellspacing="0">
          ...
          <tbody>
            <tr>
              ...
              <input type="hidden" name="nofaktur" id="nofaktur" value="<?php echo $faktur->no_faktur_internal ?>">
        ...
        <form action="<?php echo base_url('internaldelevery/internal_selesai') ?>" id="formSelesai" class="form-inline" method="post">
          <input type="hidden" name="faktur_beli" id="faktur_beli" value="<?php echo $faktur->no_faktur_internal ?>">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="<?php echo base_url('internaldelevery/simpan_edit_item_beli') ?>" method="post">
          <div class="form-group">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#idbarang').on('input', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('internaldelevery/get_detail_produk') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang
        },
    ...
    $('#btn_add_list').on('click', function(e) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('internaldelevery/add_list_internal') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nm_barang: nm_barang,
    ...
    function list_internal() {
      $.ajax({
        type: 'ajax',
        url: '<?php echo base_url() ?>internaldelevery/data_list_internal/<?php echo $this->uri->segment(3); ?>',
        async: true,
        dataType: 'json',
        success: function(data) {
          var html = '<p>Kosong</p>';
          ...
          for (i = 0; i < data.length; i++) {
            html += '<tr>' +
              ...
              '<td style="text-align:center;">' + '<a href="javascript:;" class="item_edit" faktur="' + data[i].no_faktur_internal + '" idbarang="' + data[i].kd_barang + '" jumlah="' + data[i].jumlah + '" harga="' + data[i].harga + '" nama="' + data[i].nm_barang + '">' + data[i].jumlah + ' ' + data[i].satuan + '</a>' + '</td>' +
    ...
    $('#show_data').on('click', '.item_hapus', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('internaldelevery/hapus_item_beli') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nofaktur: nofaktur,
    ...
    $('#btnSimpan').on('click', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('internaldelevery/simpan_edit_jumlah_beli') ?>",
        dataType: "JSON",
        data: {
