          ...
          <table cellspacing="0">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" style="width: 7em" name="harga" id="harga" class="form-control" ></td>
                <!-- <td><input type="number" style="width: 5em" min="0" name="diskon" id="diskon" class="form-control"  value="0"  required></td> -->
          ...
          success: function(data) {
            ...
            for (i = 0; i < data.length; i++) {
              html += '<tr>' +
                ...
                '<td style="text-align:right;">' + data[i].diskon + '</td>' +
            ...
            html += '<tr>' +
              ...
              '<th style="text-align:center; font-size : 14px;">' + diskon + '</th>' +
