  ...
  <div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <form class="form-horizontal" action="<?php echo base_url('m_pembelian/simpan_returbeli') ?>" method="post">
            <div class="form-group">
              <label class="control-label col-sm-2" for="nofak">Nomor Faktur</label>
              <div class="col-sm-5">
                <input type="text" class="form-control" id="nofak" name="nofak" value="<?php echo $produk->no_faktur_pembelian ?>" readonly="readonly">
              </div>
            </div>
            <div class="form-group">
