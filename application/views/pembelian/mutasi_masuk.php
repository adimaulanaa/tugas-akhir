  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="<?php echo base_url('mutasi/mutasi_selesai') ?>" id="formSelesai" class="form-inline" method="post">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#btn_add_list').on('click', function(e) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/add_list_mutasi') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nm_barang: nm_barang,
    ...
    function list_mutasi() {
      $.ajax({
        type: 'ajax',
        url: '<?php echo base_url() ?>mutasi/data_list_mutasi/<?php echo $this->uri->segment(3); ?>',
        async: true,
        dataType: 'json',
        success: function(data) {
          var html = '<p>Kosong</p>';
    ...
    $('#show_data').on('click', '.item_hapus', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/hapus_item_beli') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nofaktur: nofaktur,
    ...
    $('#btnSimpan').on('click', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/simpan_edit_jumlah_beli') ?>",
        dataType: "JSON",
        data: {
