<div class="content-wrapper">
  <div class="container">
    <div class="row pad-botm">
      <div class="col-md-12">
        <h4 class="header-line">CARI FAKTUR PEMBELIAN</h4>
          </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <form class="form-inline" id="formRetur" action="" method="post">
          ...
          <button type="submit" id="btnLihatFaktur" class="btn btn-default">LIHAT</button>
        </form>
        <br>
...
<script>
  ...
  $(document).ready(function() {
    $("#btnLihatFaktur").click(function(e) {
      e.preventDefault();
      var nofak = $('#nofak').val();
      $(this).html("SEARCHING...").attr("disabled", "disabled");
      $.ajax({
        url: '<?php echo base_url('m_pembelian/get_data_faktur') ?>',
        type: 'POST',
        data: {
          nofak: nofak
        },
