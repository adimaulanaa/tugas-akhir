<div class="content-wrapper" style="margin-bottom: 20px">
    <div class="container">
      <div class="row pad-botm">
          <div class="col-md-12">
              <h4 class="header-line">PEMBELIAN PENDING <span><a class="btn btn-danger pull-right" href="<?php echo base_url('m_pembelian/nomor-faktur-new/') ?>">Transaksi Faktur Baru</a></span></h4>
          </div>
      </div>
      <div class="row">
        <div class="col-md-12">
            <table id="tbPending" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="center"><a href="<?php echo base_url('m_pembelian/beli-barang/') . $key->no_faktur_pembelian ?>">Lanjut</a> | <a onclick="return confirm('Yakin hapus faktur ini?')" href="<?php echo base_url('m_pembelian/hapus-faktur/') . $key->no_faktur_pembelian ?>">Hapus</a></td>
                </tr>
                <?php endforeach?>
              </tbody>
            </table>
