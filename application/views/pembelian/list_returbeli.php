    ...
    <?php if ($faktur): ?>
      <?php foreach ($list as $l): ?>
        <tr>
          ...
          <td style="text-align: center"><a href="javascript:void(0);" class="retur_item" data-nofak='<?php echo $l->no_faktur_pembelian ?>' data-kode='<?php echo $l->kd_barang ?>'>Retur</a></td>
        </tr>
    <?php endforeach;?>
    <?php else: ?>
...
<script>
   $(document).ready(function() {
        $('#tbRetur').on('click','.retur_item',function(){
            ...
            window.location.href = "<?php echo base_url('m_pembelian/returbeli_item/') ?>"+nofak+"/"+kode_enk;
        });
    });
</script>