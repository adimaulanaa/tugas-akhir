<div class="content-wrapper" style="margin-bottom: 20px">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
              <table style="width: 100%;height: 120px;">
                <tr>
                  <td style="font-size: 18pt"><strong> TOTAL </strong></td>
                  <?php if ($faktur->diskon > 0) : ?>
                    <td align="right" style="font-size: 32pt"><strong><?php echo number_format($faktur->total_pembelian_sdiskon, 0, ',', '.') ?></strong></td>
                  <?php else : ?>
                    <td align="right" style="font-size: 32pt"><strong><?php echo number_format($belanja->tot_bel, 0, ',', '.') ?></strong></td>
                  <?php endif ?>
                </tr>
                <!-- <tr>
                  <td style="font-size: 18pt;color: red;">GRAND TOTAL</td>
              ...
              <div>
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="hidden" name="nofak" id="nofak" value="<?php echo $faktur->no_faktur_pembelian ?>">
              ...
              <hr>
              <div>
                <form class="form-inline" action="<?php echo base_url('m_pembelian/hitung-diskon/') ?>" method="post">
                  <input type="hidden" name="nofak_dis" id="nofak_dis" value="<?php echo $faktur->no_faktur_pembelian ?>">
                  <input type="hidden" name="sum_belanja" id="sum_belanja" value="<?php echo $belanja->tot_bel ?>">
                  <!-- <input style="width: 40%;text-align: right;" type="text" class="form-control" id="diskon" placeholder="PPN (Rp)" name="diskon" required="required">
              ...
              <hr>
              <div>
                <form class="form-inline" action="<?php echo base_url('m_pembelian/go_to_bayar/') ?>" method="post">
                  <input type="hidden" name="nofak_bayar" id="nofak_bayar" value="<?php echo $faktur->no_faktur_pembelian ?>">
        ...
        <div class="col-md-8">
          <div class="panel panel-default">
            <div class="panel-heading">
              Faktur : <?php echo $faktur->no_faktur_pembelian ?><span class="pull-right"><?php echo date_indo($tgl) ?> <span id="waktu"></span></span>
            </div>
            <div class="panel-body">
              <table id="tbUser" class="table table-bordered table-responsive">
                ...
                <tbody>
                  <?php foreach ($list->result() as $key) : ?>
                    <tr>
                      <td align="center"><a onclick="return confirm('Yakin hapus data ini?');" href="<?php echo base_url('m_pembelian/hapus-barang-beli/') . $key->no_faktur_pembelian . "/" . $key->kd_barang ?>">Hapus</a></td>
                      ...
                      <!-- <td align="center">
                        <form action="<?php echo base_url('m_pembelian/edit_satuan_beli/') ?>" method="post">
                          <input name="kd_barang_e" type="hidden" id="kd_barang_e" value="<?php echo $key->kd_barang ?>" />
                          <input name="nofak_e" type="hidden" id="nofak_e" value="<?php echo $key->no_faktur_pembelian ?>" />
                          <input style="text-align: center;" name="satuan" type="text" id="satuan" size="3" onkeypress="return event" value="" />
                        </form>
                      </td> -->
                      <td align="center">
                        <form action="<?php echo base_url('m_pembelian/edit_jumlah_beli/') ?>" method="post">
                          <input name="kd_barang_e" type="hidden" id="kd_barang_e" value="<?php echo $key->kd_barang ?>" />
                          <input name="nofak_e" type="hidden" id="nofak_e" value="<?php echo $key->no_faktur_pembelian ?>" />
                      ...
                      <td align="center">
                        <form action="<?php echo base_url('m_pembelian/edit_diskon_beli/') ?>" method="post">
                          <input name="kd_barang_d" type="hidden" id="kd_barang_d" value="<?php echo $key->kd_barang ?>" />
                          <input name="nofak_d" type="hidden" id="nofak_d" value="<?php echo $key->no_faktur_pembelian ?>" />
                      ...
                      <td align="right"><?php echo number_format($key->sub_total_beli, 0, ',', '.') ?></td>
                    </tr>
                    <?php
                    $tot_item += $key->jumlah;
              ...
              <a class="btn btn-danger pull-right" href="<?php echo base_url('m_pembelian/pembelian-pending/') ?>">Pending</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      $("ul.nav li.dropdown").hover(function() {
        $(this).find(".dropdown-Barang").stop(!0, !0).delay(100).fadeIn(500)
      }, function() {
        $(this).find(".dropdown-Barang").stop(!0, !0).delay(100).fadeOut(500)
      });
      ...
      $(document).ready(function() {
        ...
        $('#nm_barang').autocomplete({
          source: "<?php echo base_url('m_pembelian/get_autocomplete/?'); ?>",
      ...
      $("#kd_barang").keypress(function(e) {
        ...
        if (e.which == 13) {
          if (kd_barang) {
            window.top.location.href = "<?php echo base_url('m_pembelian/cekbarang/') ?>" + nofak + "/" + kd_barang;
          }
          return false;
        }
      });
