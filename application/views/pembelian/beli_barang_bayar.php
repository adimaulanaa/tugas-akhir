            ...
            <div class="panel-body">
              ...
              <div>
                <div class="form-inline">
                  ...
                  <input type="hidden" name="sum_belanja" id="sum_belanja" value="<?php echo $faktur->total_pembelian_sdiskon ?>">
              ...
              <br><hr>
                <div>
                <form target="printstruk" id="formCetakStruk" class="form-inline" action="<?php echo base_url('m_pembelian/cetak-struk-beli/') ?>" onsubmit="window.open('about:blank','printstruk','width=500,height=400');" method="post">
                <input type="hidden" name="sum_print" id="sum_print" value="<?php echo $faktur->total_pembelian_sdiskon ?>">
                <input type="hidden" name="diskon_print" id="diskon_print" value="<?php echo $faktur->diskon ?>">
                <input type="hidden" name="nofak_print" id="nofak_print" value="<?php echo $faktur->no_faktur_pembelian ?>">
        ...
        $('#btnCetakStruk').on('click',function(e){
            ...
            if (kembali<0) {
              ...
              $('#formCetakStruk').submit(function() {
                ...
                window.location.href = "<?php echo base_url('m_pembelian/beli_barang_selesai/') ?>";
              });
            }
        });
