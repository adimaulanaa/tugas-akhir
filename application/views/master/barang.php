    ...
    <form id="formTambah" action="<?php echo base_url('m_master/simpan_barang') ?>" method="post">
        <table border="0" class="table" align="center">
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <select name="kd_kategori" id="kd_kategori" class="span6" >
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <select name="kd_supplier" id="kd_supplier" class="span6" >
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#tbBarang').on('click', '.edit_record', function() {
            ...
            $('#formTambah').attr('action', '<?php echo base_url('m_master/simpan_barang_edit') ?>');
        ...
        $('#tbBarang').on('click', '.hapus_record', function() {
            ...
            if (akses == 'manager') {
                if (result) {
                    window.location.href = '<?php echo base_url('m_master/hapus_barang/') ?>' + kode;
                }
            }
        });
    });
    ...
    $('#tbBarang').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": '<?php echo base_url(); ?>m_master/json_produk',
            "type": "POST",
        },
        "columns": [{
                "data": "kd_barang"
