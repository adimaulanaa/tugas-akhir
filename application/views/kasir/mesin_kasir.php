        ...
        <div class="col-md-4">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <br>
              <div>
                <button type="submit" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right">Bayar</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" action="<?php echo base_url('kasir/go_to_bayar/') ?>" method="post">
