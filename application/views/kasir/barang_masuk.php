  <div class="content-wrapper" style="margin-bottom: 20px">
    <div class="container">
      <div class="row pad-botm">
        <div class="col-md-12">
          <h4 class="header-line">PENAMBAHAN BARANG <?php echo date_indo($tanggal) ?> <span class="pull-right"><a id="btnLihat" class="btn btn-danger" href="<?php echo base_url('kasir/cetak-barang-masuk') ?>">Cetak</a></span></h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
