<div class="content-wrapper" style="margin-bottom: 20px">
  <div class="container">
    <div class="row pad-botm">
      <div class="col-md-12">
        <h4 class="header-line">No. Faktur : <?php echo $faktur->no_faktur_mutasi ?></h4>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <table cellspacing="0">
          ...
          <tbody>
            <tr>
              ...
              <input type="hidden" name="nofaktur" id="nofaktur" value="<?php echo $faktur->no_faktur_mutasi ?>">
        ...
        <form action="<?php echo base_url('mutasi/mutasi_keluar_selesai') ?>" id="formSelesai" class="form-inline" method="post">
          <input type="hidden" name="faktur_beli" id="faktur_beli" value="<?php echo $faktur->no_faktur_mutasi ?>">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#idbarang').on('input', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/get_detail_produk') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang
        },
    ...
    $('#btn_add_list').on('click', function(e) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/add_list_mutasi_keluar') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nm_barang: nm_barang,
    ...
    function list_mutasi_keluar() {
      $.ajax({
        type: 'ajax',
        url: '<?php echo base_url() ?>mutasi/data_list_mutasi_keluar/<?php echo $this->uri->segment(3); ?>',
        async: true,
        dataType: 'json',
        success: function(data) {
          var html = '<p>Kosong</p>';
          ...
          for (i = 0; i < data.length; i++) {
            html += '<tr>' +
              ...
              '<td style="text-align:center;">' + '<a href="javascript:;" class="item_edit" faktur="' + data[i].no_faktur_mutasi + '" idbarang="' + data[i].kd_barang + '" jumlah="' + data[i].jumlah + '" harga="' + data[i].harga + '" nama="' + data[i].nm_barang + '">' + data[i].jumlah + ' ' + data[i].satuan + '</a>' + '</td>' +
    ...
    $('#show_data').on('click', '.item_hapus', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/hapus_item_beli_keluar') ?>",
        dataType: "JSON",
        data: {
          idbarang: idbarang,
          nofaktur: nofaktur,
    ...
    $('#btnSimpan').on('click', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('mutasi/simpan_edit_jumlah_beli_keluar') ?>",
        dataType: "JSON",
        data: {
