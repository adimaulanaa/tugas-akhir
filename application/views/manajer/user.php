            ...
            <tbody>
              <?php foreach ($user->result() as $key) : ?>
                <tr>
                  ...
                  <td align="center"><a href="" id="tbUser" class="edit_record" data-id="<?php echo $key->id_user ?>" data-nama="<?php echo $key->nm_user ?>" data-akses="<?php echo $key->akses ?>">Edit</a> | <a href="javascript:void(0);" class="hapus_record" data-id="<?php echo $key->id_user ?>">Hapus</a></td>
                </tr>
              <?php endforeach ?>
            </tbody>
          </table>
