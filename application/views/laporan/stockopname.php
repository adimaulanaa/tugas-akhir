<div class="content-wrapper" style="margin-bottom: 20px">
    <div class="container">
      <div class="row pad-botm">
        <div class="col-md-12">
          <h4 class="header-line">LAPORAN STOCKOPNAME</h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12" align="center">
          <form class="form-inline" target="_blank" action="<?php echo base_url('laporan/view_stockopname/') ?>" method="post">
            ...
            <div>
               <input type="submit" class="btn btn-warning" name="action" value="Tampilkan" />
              <!-- <input type="submit" class="btn btn-warning" name="action" value="Semua" />
              <input type="submit" class="btn btn-warning" name="action" value="Bertambah" />
              <input type="submit" class="btn btn-success" name="action" value="Berkurang" /> -->
            </div>
          </form>
        </div>
      </div>
