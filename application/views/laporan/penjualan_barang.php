    ...
    <table id="tbPenjualan" class="table table-bordered table-striped table-responsive">
      ...
      <tbody>
        <?php foreach ($penjualan->result() as $key) : ?>
          ...
          <tr>
            ...
            <td style="text-align:left;">Rp. <?php echo number_format($jum_hrg, 0, ',', '.') ?></td>
          </tr>
          <?php
          $tot += $jum_tot;
          $hrg += $jum_hrg;
      ...
      <tfoot>
        <tr>
          ...
          <td style="text-align:left;">Rp. <?php echo number_format($hrg, 0, ',', '.') ?></td>
      </tfoot>
    </table>
  </div>
</body>
