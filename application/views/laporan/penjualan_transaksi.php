            ...
            <table id="tbPenjualan" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td align="center"><a href="javascript:void(0);" class="lihat_print" title="Lihat Detail" data-faktur="<?php echo $key->no_faktur_penjualan ?>">Lihat</a></td> -->
                </tr>
<?php
...
?>
    ...
    <script>
    $('#tbPenjualan').on('click','.lihat_print',function(){
        var faktur = $(this).data('faktur');
        var url = "<?php echo base_url('kasir/test_print/') ?>"+faktur;
        window.open(url, '_blank', 'location=yes,height=400,width=500,scrollbars=yes,status=yes');
    });
    </script>
    <script src="https://cdn.jsdelivr.net/npm/recta/dist/recta.js"></script>
    <!-- <script type="text/javascript">
      $('#tbPenjualan').on('click','.print',function(){
