    ...
    <div class="container">
        <div align="center" class="no-print" id="formFilter" style="background-color: #F5F5F5;padding: 4px">
          <form class="form-inline" action="" method="get">
            ...
            <h4 align="center">LAPORAN PEMBELIAN BARANG</h4>
            ...
            <table id="tbpembelian" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <!-- <td align="right"><?php echo number_format($key->total_pembelian_sdiskon, 0, ',', '.') ?></td> -->
                  <td align="right"><?php echo number_format($key->cash, 0, ',', '.') ?></td>
                  <td align="right"><?php echo number_format($key->debet, 0, ',', '.') ?></td>
                  <td><?php echo $key->ket ?></td>
                  <td><?php echo $key->id_user ?></td>
                  <td align="center"><a href="javascript:void(0);" class="lihat_record" title="Lihat Detail" data-faktur="<?php echo $key->no_faktur_pembelian ?>">Lihat</a></td>
                </tr>
<?php
$subtot += $key->total_pembelian;
$diskon += $key->diskon;
$grandtot += $key->total_pembelian_sdiskon;
$cash += $key->cash;
$debet += $key->debet;
?>
                <?php endforeach?>
    ...
    $('#tbpembelian').on('click','.lihat_record',function(){
        ...
        var url = "<?php echo base_url('m_pembelian/cetak_data_faktur/') ?>"+faktur;
