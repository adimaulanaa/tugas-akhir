...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Laporan Pemakaian Toko</title>
    ...
    <div class="container">
        <div align="center" class="no-print" id="formFilter" style="background-color: #F5F5F5;padding: 4px">
          <form class="form-inline" action="" method="get">
            ...
            <h4 align="center">LAPORAN PEMAKAIAN TOKO</h4>
            ...
            <table id="tbpembelian" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                <?php foreach ($pakai->result() as $key): ?>
                <tr>
                  <td align="center"><?php echo $no++ ?></td>
                  <td><?php echo $key->no_faktur_pemakaiantoko ?></td>
                  <td><?php echo $key->tgl_pemakaian ?></td>
                  <td align="right"><?php echo number_format($key->total_pemakaiantoko, 0, ',', '.') ?></td>
                  <td align="center"><a href="javascript:void(0);" class="lihat_record" title="Lihat Detail" data-faktur="<?php echo $key->no_faktur_pemakaiantoko ?>">Lihat</a></td>
                </tr>
<?php
$subtot += $key->total_pemakaiantoko;
// $diskon += $key->diskon;
// $grandtot += $key->total_internal_sdiskon;
// $cash += $key->cash;
// $debet += $key->debet;
?>
                <?php endforeach?>
    ...
    $('#tbpembelian').on('click','.lihat_record',function(){
        ...
        var url = "<?php echo base_url('pemakaiantoko/cetak_pemakaiantoko/') ?>"+faktur;
