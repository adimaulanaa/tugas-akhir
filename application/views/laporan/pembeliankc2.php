...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Laporan Pembelian KC</title>
...
<body>
    <div class="container">
        ...
        <h4 align="center">LAPORAN PEMBELIAN KC</h4>
            ...
            <tbody>
                <?php foreach ($internal->result() as $key) : ?>
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo $key->no_faktur_internal ?></td>
                        <td><?php echo date_indo($key->tgl_internal) ?></td>
