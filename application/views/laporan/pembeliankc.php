    ...
    <div class="container">
        <div align="center" class="no-print" id="formFilter" style="background-color: #F5F5F5;padding: 4px">
          <form class="form-inline" action="" method="get">
            ...
            <h4 align="center">LAPORAN INTERNAL</h4>
            ...
            <table id="tbpembelian" class="table table-bordered table-striped table-responsive">
              ...
              <tbody>
                <?php foreach ($internal->result() as $key): ?>
                <tr>
                  <td align="center"><?php echo $no++ ?></td>
                  <td><?php echo $key->no_faktur_internal ?></td>
                  <td><?php echo $key->tgl_internal ?></td>
                  <td align="right"><?php echo number_format($key->total_internal, 0, ',', '.') ?></td>
                  <td align="center"><a href="javascript:void(0);" class="lihat_record" title="Lihat Detail" data-faktur="<?php echo $key->no_faktur_internal ?>">Lihat</a></td>
                </tr>
<?php
$subtot += $key->total_internal;
// $diskon += $key->diskon;
...
?>
    ...
    $('#tbpembelian').on('click','.lihat_record',function(){
        ...
        var url = "<?php echo base_url('internaldelevery/cetak_data_faktur/') ?>"+faktur;
